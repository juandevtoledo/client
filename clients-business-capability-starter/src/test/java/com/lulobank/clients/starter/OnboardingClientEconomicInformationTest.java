...
public class OnboardingClientEconomicInformationTest extends AbstractBaseIntegrationTest {
  private static final String TESTED_URL = "/onboarding/{idClient}/economicinformation";
