...
public class AddResponseHeaderFilterTest {
  ...
  public void testWhenJWTPresent() throws IOException, ServletException {
    ...
    maintenanceFilter.doFilter(httpServletRequest, httpServletResponse, filterChain);
